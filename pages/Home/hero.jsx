    ...
    <>
      <div className="p-4 px-8 font-serif flex flex-col mt-12 md:mt-0 md:flex-row justify-evenly">
        <div className="w-full md:w-1/2 flex flex-col justify-center items-center">
          ...
          <h2 className="font-semibold text-xl pl-4 pt-2 bg-gradient-to-r from-black via-purple-800 to-red-800 bg-clip-text text-transparent"
            data-aos="zoom-in"
            data-aos-delay="600"
            data-aos-duration="2000">
            Best Wedding Planner in India
          </h2>
          <h2 className=" flex gap-2 font-semibold text-xl pl-4 pt-4 bg-gradient-to-r from-black to-purple-800 bg-clip-text text-transparent"
            data-aos="zoom-in"
            data-aos-delay="600"
            data-aos-duration="2000">
            Offering <p className="text-3xl shadow-sm shadow-purple-500 rounded-lg px-2">Shadi On EMI</p>
          </h2>
          ...
          <p className="text-lg text-purple-950 mt-4"
            ...
            data-aos-delay="1000"
            data-aos-duration="2000">
            We provide EMI option on Events, where you enjoy your shadi now and pay 
